...
public abstract class AVLTree<E extends Comparable<E>> extends BST<E> {
    ...
    public boolean delete(E element) {
        ...
        while (current != null) {
            ...
            else if (compare(element, current.element) > 0) {
                parent = current;
    ...
    protected abstract FSAVLTree.FSAVLTreeNode<String> FSAVLTreeNode(String fileName);
